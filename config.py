...
BOT_NAME = getenv("BOT_NAME", "Hsisjs")
...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Drama_boy1")
ALIVE_NAME = getenv("ALIVE_NAME", "𝐏𝐫𝐢𝐧𝐜𝐞 𝐜𝐡𝐚𝐫𝐦𝐢𝐧𝐠👑")
BOT_USERNAME = getenv("BOT_USERNAME", "pincy_robot")
OWNER_ID = getenv("OWNER_ID", "6516561672")
...
HEROKU_API_KEY = getenv("UPDATES_CHANNEL", "None")
